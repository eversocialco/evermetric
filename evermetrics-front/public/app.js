...
module.exports = function (ctx, dates) {
  ...
  var authenticated = yo(_templateObject, loadMenuFb(ctx, dates), loadMenuInst(ctx, dates), loadMenuTwit(ctx, dates), loadMenuWeb(ctx, dates), loadDatesFb(ctx, dates), loadDatesInst(ctx, dates), loadDatesTw(ctx, dates), loadDatesWeb(ctx, dates));
    ...
    if (dates[i].userId === ctx.auth.username) {
      ...
      if (hay === 1) {
        ...
        if (mostrardatosinst === 1) {
          return yo(_templateObject3, loadViewTabs(ctx, dates, red));
        }
      } else if (hay === 2) {
        hay = 0;
        ++contins;
    ...
    if (dates[i].userId === ctx.auth.username) {
      ...
      if (hay === 1) {
        ...
        if (mostrarItemsInst === 1) {
          return yo(_templateObject5, loadMenuYear(ctx, dates, 'it'), loadMenuMonths(ctx, dates, 'it'));
        }
      }
    }
  }
  ...
  for (var i in dates) {
    if (dates[i].userId === ctx.auth.username) {
      ...
      if (hay === 1) {
        ...
        ++mostrardatosfb;
        if (mostrardatosfb === 1) {
          return yo(_templateObject6, loadViewTabs(ctx, dates, red));
        }
      } else if (hay === 2) {
        hay = 0;
        ++contfb;
  ...
  for (var i in dates) {
    if (dates[i].userId === ctx.auth.username) {
      ...
      if (hay === 1) {
        ...
        ++mostrarItemsfb;
        if (mostrarItemsfb === 1) {
          return yo(_templateObject7, loadMenuYear(ctx, dates, red), loadMenuMonths(ctx, dates, red));
        }
      }
    }
  }
    ...
    if (dates[i].userId === ctx.auth.username) {
      ...
      if (hay === 1) {
        ...
        if (mostrarItemsweb === 1) {
          return yo(_templateObject8, loadMenuYear(ctx, dates, 'wb'), loadMenuMonths(ctx, dates, 'wb'));
        }
      }
    }
  }
  ...
  for (var i in dates) {
    if (dates[i].userId === ctx.auth.username) {
      ...
      if (hay === 1) {
        ...
        ++mostrarItemstw;
        if (mostrarItemstw === 1) {
          return yo(_templateObject9, loadMenuYear(ctx, dates, red), loadMenuMonths(ctx, dates, red));
        }
      }
    }
  }
...
function liMenuYear(ctx, dates, dato, red) {
  return yo(_templateObject10, red, dato.year, dato.year);
}
