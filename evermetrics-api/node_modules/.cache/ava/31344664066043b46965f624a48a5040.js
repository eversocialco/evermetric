...
(0, _ava2.default)('Get /:id', (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    let id = _uuidBase2.default.v4(); // generamos un id random

    let srv = (0, _micro2.default)((() => {
      var _ref2 = (0, _asyncToGenerator3.default)(function* (req, res) {
        (0, _micro.send)(res, 200, { id: id }); // enviamos la respuesta
      });
...
//# sourceMappingURL=../node_modules/.cache/ava/31344664066043b46965f624a48a5040.js.map