...
var _estadisticas = require('../estadisticas');
...
_ava2.default.beforeEach((() => {
  var _ref = (0, _asyncToGenerator3.default)(function* (t) {
    let srv = (0, _micro2.default)(_estadisticas2.default);
...
(0, _ava2.default)('GET /:id', (() => {
  var _ref2 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    let dates = _fixtures2.default.getEstadisticas();
    let url = t.context.url;

    let body = yield (0, _requestPromise2.default)({ url: `${ url }/${ dates.publicId }`, json: true });
    t.deepEqual(_rec._expr(_rec._capt(body, 'arguments/0'), {
      content: 't.deepEqual(body, dates)',
      filepath: 'test/estadisticas-test.js',
      line: 22,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"Identifier","name":"body","range":[12,16]},{"type":"Identifier","name":"dates","range":[18,23]}],"range":[0,24]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"body","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"name"},"value":"dates","range":[18,23]},{"type":{"label":")"},"range":[23,24]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec2._expr(_rec2._capt(dates, 'arguments/1'), {
      content: 't.deepEqual(body, dates)',
      filepath: 'test/estadisticas-test.js',
      line: 22,
      async: true,
...
(0, _ava2.default)('GET /list', (() => {
  var _ref3 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    let dates = _fixtures2.default.getEstadisticasp();
    let url = t.context.url;
    ...
    t.deepEqual(_rec3._expr(_rec3._capt(body, 'arguments/0'), {
      ...
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"body","range":[12,16]},{"type":{"label":","},"range":[16,17]},{"type":{"label":"name"},"value":"dates","range":[18,23]},{"type":{"label":")"},"range":[23,24]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec4._expr(_rec4._capt(dates, 'arguments/1'), {
      content: 't.deepEqual(body, dates)',
      filepath: 'test/estadisticas-test.js',
      line: 37,
      async: true,
...
(0, _ava2.default)('no token POST /', (() => {
  var _ref4 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    t.throws(_avaThrowsHelper(function () {
      ...
      filename: '/Volumes/Macintosh HD/eversocial6/Desktop/evermetrics-api/test/estadisticas-test.js'
    }), /invalid token/);
  });
...
(0, _ava2.default)('secure POST /', (() => {
  var _ref5 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    let dates = _fixtures2.default.getEstadisticas();
    let url = t.context.url;
    let token = yield _utils2.default.signToken({ userId: dates.userId }, _config2.default.secret);
    ...
    t.is(_rec5._expr(_rec5._capt(_rec5._capt(response, 'arguments/0/object').statusCode, 'arguments/0'), {
    ...
    t.deepEqual(_rec6._expr(_rec6._capt(_rec6._capt(response, 'arguments/0/object').body, 'arguments/0'), {
      content: 't.deepEqual(response.body, dates)',
      filepath: 'test/estadisticas-test.js',
      line: 92,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"response","range":[12,20]},"property":{"type":"Identifier","name":"body","range":[21,25]},"computed":false,"range":[12,25]},{"type":"Identifier","name":"dates","range":[27,32]}],"range":[0,33]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"response","range":[12,20]},{"type":{"label":"."},"range":[20,21]},{"type":{"label":"name"},"value":"body","range":[21,25]},{"type":{"label":","},"range":[25,26]},{"type":{"label":"name"},"value":"dates","range":[27,32]},{"type":{"label":")"},"range":[32,33]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec7._expr(_rec7._capt(dates, 'arguments/1'), {
      content: 't.deepEqual(response.body, dates)',
      filepath: 'test/estadisticas-test.js',
      line: 92,
      async: true,
...
//# sourceMappingURL=../node_modules/.cache/ava/4a694a3846f52fad6192c3c849942736.js.map