...
(0, _ava2.default)('success POST /', (() => {
  var _ref2 = (0, _asyncToGenerator3.default)(function* (t) {
    ...
    t.is(_rec._expr(_rec._capt(_rec._capt(decoded, 'arguments/0/object').username, 'arguments/0'), {
      content: 't.is(decoded.username, user.username)',
      filepath: 'test/auth-test.js',
      line: 34,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"decoded","range":[5,12]},"property":{"type":"Identifier","name":"username","range":[13,21]},"computed":false,"range":[5,21]},{"type":"MemberExpression","object":{"type":"Identifier","name":"user","range":[23,27]},"property":{"type":"Identifier","name":"username","range":[28,36]},"computed":false,"range":[23,36]}],"range":[0,37]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"decoded","range":[5,12]},{"type":{"label":"."},"range":[12,13]},{"type":{"label":"name"},"value":"username","range":[13,21]},{"type":{"label":","},"range":[21,22]},{"type":{"label":"name"},"value":"user","range":[23,27]},{"type":{"label":"."},"range":[27,28]},{"type":{"label":"name"},"value":"username","range":[28,36]},{"type":{"label":")"},"range":[36,37]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), _rec2._expr(_rec2._capt(_rec2._capt(user, 'arguments/1/object').username, 'arguments/1'), {
      content: 't.is(decoded.username, user.username)',
      filepath: 'test/auth-test.js',
      line: 34,
      async: true,
...
//# sourceMappingURL=../node_modules/.cache/ava/2bee3423269c0391102d5a84cb65d72c.js.map